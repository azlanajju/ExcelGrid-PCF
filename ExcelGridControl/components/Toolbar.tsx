...
export const Toolbar: React.FC<ToolbarProps> = ({ tableEditable, showAddRowButton = true, uploadDelay, showUploadButton, showDownloadButton, showAddColumnButton = true, addRow, addCol, downloadExcel, downloadExcelAll, onDataLoaded, getDropdownOptions, uploadChange }) => {
  ...
  return (
    <div className="excel-toolbar">
      ...
      {showUploadButton && <ExcelUploader uploadDelay={uploadDelay} uploadChange={uploadChange} onDataLoaded={onDataLoaded} />}
    </div>
  );
};
