...
export const Toolbar: React.FC<ToolbarProps> = ({ tableEditable, showAddRowButton = true, showAddColumnButton = true, addRow, addCol, downloadExcel, downloadExcelAll, onDataLoaded, getDropdownOptions }) => {
  ...
  return (
    <div className="excel-toolbar">
      ...
      <ExcelUploader onDataLoaded={onDataLoaded} />
    </div>
  );
};
